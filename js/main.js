...
/*************************************************************************************
------------ ANSWER -------------------
No, x and y are opposite of what they say.
console.log(y) - This will print an error saying the variable has not been declaired because y has not been declared within the scope.
console.log(x) - This will pring "I'm a local variable" because x was defined within the outter function's scope
...
x is undefined. It's been decalred by hosting but undefined.
foo() will print function hoisting because functions are hosted
...
console.log(add) will print out the add variable, which is two integers added together (2+2); so 4.
...
tomato.sauceType;
chicken.protien;
orderNow.skajdlksjdlasjdlkasjdlaskjdlkasjdlkasjdlkasjdalksdj
sauce.saljdakljdlaksjdlaskjdalskjdalskjdaslkdjalskdjaslkdj
  var pizza = {
    sauce: "",
    orderNow: "",
    pizzaMkr: function(){
